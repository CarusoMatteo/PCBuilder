        ...
        Scaffold(
            ...
            topBar = {
                TopAppBar(
                    ...
                    title = { Text(text = stringResource(ramFilters_Text)) },
            ...
            Column(
                ...
                FilterListHeader(
                    text = stringResource(totalSize_Text)
                )

                FilterFlowRow(
                    component = RAM,
                    name = stringResource(totalSize_Text),
                    somethingWasChanged = somethingWasChanged
                )
                ...
                FilterListHeader(
                    text = stringResource(numberOfSticks_Text)
                )

                FilterFlowRow(
                    component = RAM,
                    name = stringResource(numberOfSticks_Text),
                    somethingWasChanged = somethingWasChanged
                )
                ...
                FilterListHeader(
                    text = stringResource(memorySpeed_Text)
                )

                FilterFlowRow(
                    component = RAM,
                    name = stringResource(memorySpeed_Text),
                    somethingWasChanged = somethingWasChanged
                )
